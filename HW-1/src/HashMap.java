/**
 *Hashmap is a data structure which implements an associative array abstract data type, a structure that can map keys to values.
 */
public class HashMap{
    ...
    private class List {
        public class Node{
            ...
            public Node(String stringValue, String key){ this.stringValue = stringValue; keyValue = key; }
        }
        public Node head = null;
        public int size = 0;
        public void insert(String stringValue, String key){
            if (size == 0) {
        ...
        public boolean find(String key){
            ...
            return  (now != null && now.keyValue.equals(key));
        }
        ...
        public void delete(String key){
            ...
            if (now != null && now.keyValue.equals(key)){
                if (now.prevNode == null){ head = now.nextNode; }
